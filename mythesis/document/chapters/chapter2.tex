...
The cobot concept was initially proposed by J. Edward Colgate and Michael Pashkin in 1996 [2,4 - confirmar], with the first commercial cobot, the UR5 
...
\subsubsection{Comparative Analysis with Traditional Robots}
...
% Falta a parte da conclusao. adicionar figuras, tabelas, imagens do artigo
% %%%%%%%%%%%%%%%%%%%%%%%% 

% %%%%%%%%%%%%%%%%%%%%%%%% ver a parte abaixo dos cenarios de colaboracao - o que fazer com isto. integrar melhor depois da parte de ar e dt estarem
% %%%%%%%%%%%%%%%%%%%%%%%% definidas. deixar o que está abaixo? ou mover para a parte de depois de introduzir os DT
...
% Therefore, addressing this \ac{DT} definition misconception, Liu et al.~\cite{liu2022state} define the three types of interaction as follows:
