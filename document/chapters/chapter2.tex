...
model by Universal Robots \footnote{\url{https://www.universal-robots.com/products/ur5-robot/}, acessed in 2022-09-22}, being sold in 2008 \cite{robotics8040100}. 
...
\footnote{\url{https://www.fanuc.eu/it/en/robots/robot-filter-page/m-2000-series}, acessed in 2022-09-22} \cite{robotics8040100}. 
...
\subsubsection{Augmented Reality (\ac{AR})}
    \ac{AR} enhances the user perception of the real world by overlaying digital content such as 3D graphics, information, or media directly 
    onto their physical surroundings \cite{liu2022digitaltwin}. 
    This technology enables the virtual content to interact dynamically with the environment in real-time and its ideal outcome is for users
...
\subsubsection{Virtual Reality (\ac{VR})}
    Immerses users in a completely synthetic environment, isolating them from the physical world. This immersion is achieved through 
    \ac{HMD}, such as the Oculus Quest 2 depicted in figure \ref{f:quest-2-vr}, that provide a fully virtual view, with technologies such as head 
    tracking enhancing the experience by allowing natural movements to influence the virtual environment.
    
    \ac{VR} typically features individual experiences and can transport users to remote or imaginary locations, offering a profound sense 
    of presence in a digitally constructed reality \cite{whatismixedreality}.
    
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.75\linewidth]{figs/oculus-2-vr.png}
        \caption{Oculus Quest 2 - \ac{VR} headset}
        \label{f:quest-2-vr}
    \end{figure}
...
\begin{enumerate}
    ...
    \begin{figure}[htp]
        ...
        \begin{subfigure}{.5\textwidth}
            ...
            \label{fig:sfig4}
        \end{subfigure}
        \caption{AR displayed work envelope of robotic arm \cite{Chu2023}}
        \label{fig:ar-envelope}
    \end{figure}
    
    \item \textbf{Virtual and Augmented Reality for Intuitive Robot Programming}
    
    Programming robots using Virtual Reality (VR) and DT introduces innovative methods that capture human movements, reducing the learning curve for 
