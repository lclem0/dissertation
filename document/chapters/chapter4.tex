...
%         \centering
%         \includegraphics[width=\textwidth]{figs/framework-1.jpeg}
%     \label{fig:subfig1}
%     \end{subfigure}
...
%         \caption{environment}
%         \centering
%         \includegraphics[width=0.7\textwidth]{figs/mr-collab.png}
%         \label{fig:subfig2}
%     \end{subfigure}
%     \caption{asdfasfdas}
...
% *TODO: check this, it was mounted on top of the robot (?-lie) - eurico missing correction
