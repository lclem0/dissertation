...
% citing cobots in Aaltonen2019 (above) because cobots consist on the new robot that must adapt to frequent changes in production tasks, requiring advanced cognitive capabilities, to handle non-repetitive operations.
