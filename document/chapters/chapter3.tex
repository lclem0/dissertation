...
After further analysis, three control methods were implemented.

Firstly a \ac{UI} was desgined to allow the on-site member to control each robot joint individually by using a panel 
